...
function IconDoc() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
      <path d="M6 2h9l5 5v15a1 1 0 01-1 1H5a1 1 0 01-1-1V3a1 1 0 011-1z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round"/>
      <path d="M14 2v5h5M8 12h8M8 16h5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/>
    </svg>
  );
}
...
function IconGraduate() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
      ...
      <path d="M6 10v5c0 2.21 2.69 4 6 4s6-1.79 6-4v-5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/>
    </svg>
  );
}
      ...
      <div className={styles.mainWrapper}>
        <header className={styles.topbar}>
          <div className={styles.notifBtn}>
            <span className={styles.notifIcon}><IconBell /></span>
