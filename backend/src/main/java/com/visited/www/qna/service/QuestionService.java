...
public interface QuestionService {
    ...
    /** 전체 사용자 질문 목록 (모든 사용자 열람) */
    PageResponse<PublicQuestionListResponseDto> getAllQuestions(Pageable pageable);

    /** 전체 질문 상세 (소유자 검증 없음) */
    PublicQuestionDetailResponseDto getPublicQuestion(Long questionId);
